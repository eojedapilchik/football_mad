...
async def connect_sddp(fixture_uuid, feeds=None, include_opta_id=True):
    ...
    try:
        async with websockets.connect(uri) as websocket:
            ...
            outlet_object = {"OutletKeyService": {"outletKey": OUTLET_KEY}}
            ...
            async for raw_msg in websocket:
                ...
                if msg.get("outlet", {}).get("msg") == "is_authorised":
                    ...
                    print(
                        "❌ Not authorized! Check your outlet key or IP whitelisting."
                    )
                    print(msg)
                    break
                    ...
                    print(
                        "Live Update:", json.dumps(msg["content"]["liveData"], indent=2)
                    )
